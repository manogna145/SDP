...
var curl = "mongodb+srv://admin:admin@cluster0.yrmqoh1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
app.post('/sendemail', async function(req, res){
    try
    {
        var transport = nodemailer.createTransport({
            ...
            port: 445,
            secure: true,
            auth:{user: "manogna.krk@gmail.com", pass: "ykpwhhkdlfogqkgi"}
        });

         var emaildata = {
             from: "manogna.krk@gmail.com",
             to: "ssuhas4u@gmail.com",
